...
int main(void) {
	...
	fb.addpolygonsfinal("1,274,848 JIWA",Point(124,132), polygonFinal,0.5);
	fb.addpolygonsfinal("2,635,968 JIWA",Point(142,178), polygonFinal,0.5);
	fb.addpolygonsfinal("1,549,273 JIWA",Point(74,208), polygonFinal,0.5);
	fb.addpolygonsfinal("1,043,456 JIWA",Point(175,190), polygonFinal,0.5);
	...
	fb.addpolygonsfinal("8,860,381 JIWA",Point(198,259), polygonFinal,0.5);
	fb.addpolygonsfinal("38,965,440 JIWA",Point(205,293), polygonFinal,0.5);
	fb.addpolygonsfinal("31,977,968 JIWA",Point(248,269), polygonFinal,0.5);
	fb.addpolygonsfinal("3,594,854 JIWA",Point(243,310), polygonFinal,0.5);
	fb.addpolygonsfinal("36,294,280 JIWA",Point(298,278), polygonFinal,0.5);
	fb.addpolygonsfinal("9,028,816 JIWA",Point(123,274), polygonFinal,0.5);
	fb.addpolygonsfinal("3,383,572 JIWA",Point(334,288), polygonFinal,0.5);
	fb.addpolygonsfinal("4,184,411 JIWA",Point(335,318), polygonFinal,0.5);
	...
	fb.addpolygonsfinal("1,914,900 JIWA",Point(278,181), polygonFinal,0.5);
	fb.addpolygonsfinal("3,446,631 JIWA",Point(324,212), polygonFinal,0.5);
	fb.addpolygonsfinal("2,848,798 JIWA",Point(361,151), polygonFinal,0.5);
